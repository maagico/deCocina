 ...
 *
 */
public class GenericAdminDaoIbatisImpl<T extends ModelBase> extends SqlMapClientDaoSupport implements IGenericDao<T>
{ 
	/**
	 ...
	 * @param model Model.
	 */
	public GenericAdminDaoIbatisImpl(SqlMapClient sqlMapClient, T model) {
	...
	public List<T> findAll(Long start, Long limit) {
		...
		sbStatementName.append(".admin.findAll");
	...
	public Long countFindAll(Long start, Long limit) {
		...
		StringBuffer sbStatementName = new StringBuffer();
		sbStatementName.append(simpleName);
		sbStatementName.append(".admin.countFindAll");
	...
	public T findById(Long id){
		...
		StringBuffer sbStatementName = new StringBuffer();
		sbStatementName.append(simpleName);
		sbStatementName.append(".admin.findById");
	...
	public void insert(T entity){
		...
		StringBuffer sbStatementName = new StringBuffer();
		sbStatementName.append(simpleName);
		sbStatementName.append(".admin.insert");
	...
	public T update(T entity){
		...
		StringBuffer sbStatementName = new StringBuffer();
		sbStatementName.append(simpleName);
		sbStatementName.append(".admin.update");
	...
	public void delete(T entity){
		...
		StringBuffer sbStatementName = new StringBuffer();
		sbStatementName.append(simpleName);
		sbStatementName.append(".admin.delete");
