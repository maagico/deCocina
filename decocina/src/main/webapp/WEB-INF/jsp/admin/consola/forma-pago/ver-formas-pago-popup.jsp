					    	...
					    	<c:forEach var="formaPago" items="${formasPago}">
						    	...
						    	<tr>
						        	...
						        	<td>
						        		...
						        		<a href = "<c:url value = "/admin/consola/zona/zona-forma-pago-insert?zona_id=${id}&forma_envio_id=${idFormaEnvio}&forma_pago_id=${formaPago.id}&"/><decocina:parametros busqueda="${zonaBuscador}"/>">
